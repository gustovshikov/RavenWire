...
- [ ] 1. Sensor_Pod container definitions and base infrastructure
  - [ ] 1.1 Write Podman Quadlet container unit files for Zeek, Suricata, Vector, sensor_agent, and pcap_ring_writer
  ...
  - [ ] 1.2 Write Management_Pod Quadlet unit files for config_manager
  ...
  - [ ] 1.3 Implement startup dependency ordering and pipeline separation
...
- [ ] 2. AF_PACKET capture configuration and BPF filter validation (Phase 0)
  - [ ] 2.1 Implement capture configuration schema and parser (Go)
  ...
  - [ ]* 2.2 Write property test for capture configuration validation (Property 1)
  ...
  - [ ] 2.4 Implement BPF filter compilation and socket attachment (Go)
  ...
  - [ ] 2.5 Implement BPF filter reload in Sensor_Agent Capture Manager (Go)
  ...
  - [ ] 2.6 Expose per-consumer packet receive and drop counters
...
- [ ] 3. Sensor_Agent core — Control API and module skeleton (Phase 1)
  - [ ] 3.1 Implement Sensor_Agent binary entry point and module wiring (Go)
  ...
  - [ ] 3.2 Implement Control API module — mTLS REST server with action allowlist (Go)
  ...
  - [ ]* 3.3 Write property test for Sensor_Agent action allowlist enforcement (Property 7)
  ...
  - [ ] 3.4 Implement Local Audit Logger module (Go)
  ...
  - [ ] 3.5 Implement Host Readiness Checker module (Go)
...
- [ ] 4. Sensor_Agent — Health Collector and gRPC health stream (Phase 1)
  - [ ] 4.1 Define gRPC protobuf schema for health streaming
  ...
  - [ ] 4.2 Implement Health Collector module (Go)
  ...
  - [ ] 4.3 Implement gRPC health stream client (Go)
...
- [ ] 5. Sensor_Agent — Config Applier and offline operation (Phase 1)
  - [ ] 5.1 Implement Config Applier module (Go)
  ...
  - [ ] 5.2 Implement offline operation — continue on Management_Pod unreachable
...
- [ ] 6. Sensor_Agent — Rule Validator module (Phase 1)
  - [ ] 6.1 Implement Rule Validator module (Go)
...
- [ ] 7. Sensor_Agent — Certificate Manager and mTLS enrollment (Phase 1)
  - [ ] 7.1 Implement Certificate Manager module (Go)
  ...
  - [ ] 7.2 Implement automated certificate rotation (Go)
...
- [ ] 8. pcap_ring_writer process — Alert-Driven rolling ring buffer (Phase 1)
  - [ ] 8.1 Implement pcap_ring_writer binary (Go)
  ...
  - [ ] 8.2 Implement PCAP Manager module in Sensor_Agent (Go)
  ...
  - [ ]* 8.3 Write property test for alert-driven pre-alert window preservation (Property 4)
  ...
  - [ ] 8.4 Implement FIFO pruning for alert PCAP storage
  ...
  - [ ]* 8.5 Write property test for PCAP storage FIFO pruning invariant (Property 3)
...
- [ ] 9. Local PCAP file index — SQLite Tier 1 (Phase 1)
  - [ ] 9.1 Implement SQLite PCAP index (Go)
...
- [ ] 10. Community ID computation and preservation (Phase 1)
  - [ ] 10.1 Integrate Community ID computation into Sensor_Agent and Vector pipeline
  ...
  - [ ] 10.2 Configure Vector transformation pipeline to preserve Community ID
...
- [ ] 11. Vector log forwarding — Splunk/Cribl sink (Phase 1)
  - [ ] 11.1 Implement Vector configuration for Splunk HEC and Cribl HTTP forwarding
  ...
  - [ ] 11.2 Implement Vector config hot-reload via Sensor_Agent Config Applier
...
- [ ] 12. Config_Manager — Elixir/Phoenix application skeleton (Phase 1)
  - [ ] 12.1 Scaffold Phoenix LiveView application
  ...
  - [ ] 12.2 Implement Sensor_Pod enrollment data model and Ecto schema
  ...
  - [ ] 12.3 Implement enrollment CA — ECDSA P-256 certificate authority (Elixir)
  ...
  - [ ] 12.5 Implement CRL management and certificate rejection (Elixir)
...
- [ ] 13. Config_Manager — Health dashboard LiveView (Phase 1)
  - [ ] 13.1 Implement gRPC health stream server (Elixir)
  ...
  - [ ] 13.2 Implement health dashboard LiveView page
  ...
  - [ ] 13.3 Implement clock drift monitoring and degraded pod marking
...
- [ ] 14. Config_Manager — Enrollment UI and mode switching (Phase 1)
  - [ ] 14.1 Implement enrollment approval LiveView page
  ...
  - [ ] 14.2 Implement Alert-Driven PCAP configuration UI and mode control dispatch
...
- [ ] 15. Basic rule deployment — Suricata rules push to sensor (Phase 1)
  - [ ] 15.1 Implement rule bundle delivery via Sensor_Agent apply-pool-config action
  ...
  - [ ] 15.2 Implement rule validation before deployment (Sensor_Agent Rule Validator)
...
- [ ] 16. Support bundle generation (Phase 1)
  - [ ] 16.1 Implement support bundle generator in Sensor_Agent (Go)
  ...
  - [ ] 16.2 Implement support bundle trigger in Config_Manager UI
    - Per-Sensor_Pod "Generate Support Bundle" button in LiveView
    - Download resulting archive via Config_Manager
    - _Requirements: 25.4_

- [ ] 17. Internal dev CLI — sensorctl (Phase 1)
  - [ ] 17.1 Implement minimal sensorctl binary (Go)
...
- [ ] 18. Checkpoint — Phase 0 integration validation
...
- [ ] 19. Checkpoint — Phase 1 integration validation
