...
- [x] 1. Database migrations
  - [x] 1.1 Create the `bpf_profiles` table migration
  ...
  - [x] 1.2 Create the `bpf_filter_rules` table migration
  ...
  - [x] 1.3 Create the `bpf_profile_versions` table migration
...
- [x] 2. Ecto schemas and parameter validation
  - [x] 2.1 Implement the `BpfProfile` Ecto schema
  ...
  - [x] 2.2 Implement the `BpfFilterRule` Ecto schema
  ...
  - [x] 2.3 Implement the `BpfProfileVersion` Ecto schema
  ...
  - [x] 2.4 Implement `ConfigManager.Bpf.RuleParams` — type-specific parameter validation
  ...
  - [x]* 2.5 Write property test for rule parameter validation (Property 1)
  ...
  - [x]* 2.6 Write property test for CIDR and port validation (Property 2)
...
- [x] 3. Expression generation
  - [x] 3.1 Implement `ConfigManager.Bpf.ExpressionGenerator`
  ...
  - [x]* 3.2 Write property test for expression generation respecting enabled state and order (Property 3)
  ...
  - [x]* 3.3 Write property test for composition mode behavior (Property 4)
  ...
  - [x]* 3.4 Write property test for clause generation syntax (Property 6)
...
- [x] 4. BPF compiler
  - [x] 4.1 Implement `ConfigManager.Bpf.Compiler`
  ...
  - [x]* 4.2 Write property test for expression round-trip compilation (Property 5)
...
- [x] 6. BPF context module
  - [x] 6.1 Implement `ConfigManager.Bpf` context — profile CRUD
  ...
  - [x] 6.2 Implement `ConfigManager.Bpf` context — save profile
  ...
  - [x] 6.3 Implement `ConfigManager.Bpf` context — reset, validate, rules, versions, queries
  ...
  - [x]* 6.4 Write property test for profile creation defaults (Property 7)
  ...
  - [x]* 6.5 Write property test for version increment behavior (Property 8)
  ...
  - [x]* 6.6 Write property test for immutable version snapshots (Property 9)
  ...
  - [x]* 6.7 Write property test for reset behavior (Property 10)
  ...
  - [x]* 6.8 Write property test for cascade delete (Property 11)
  ...
  - [x]* 6.9 Write property test for transactional audit integrity (Property 14)
  ...
  - [x]* 6.10 Write property test for audit entry structure (Property 13)
  ...
  - [x]* 6.11 Write property test for pending deployment detection (Property 15)
...
- [x] 8. RBAC policy verification
  - [x] 8.1 Verify canonical `bpf:manage` permission in the Policy module
  ...
  - [x]* 8.2 Write property test for RBAC enforcement (Property 12)
...
- [x] 9. Router and Task.Supervisor setup
  - [x] 9.1 Add BPF route to the router and configure Task.Supervisor
...
- [x] 10. LiveView — BPF Editor page
  - [x] 10.1 Implement `BpfLive.EditorLive` — mount, assigns, and PubSub
  ...
  - [x] 10.2 Implement `BpfLive.EditorLive` — write event handlers
  ...
  - [x] 10.3 Implement `BpfLive.EditorLive` — template/render
...
- [x] 12. Pool navigation integration
  - [x] 12.1 Add BPF Filters tab to pool detail page navigation
