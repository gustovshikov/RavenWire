...
- [x] 1. Database migrations and schema foundations
  - [x] 1.1 Create the `forwarding_sinks` table migration
  ...
  - [x] 1.2 Create the `sink_secrets` table migration
  ...
  - [x] 1.3 Create the migration to add forwarding fields to `sensor_pools`
...
- [x] 2. Ecto schemas
  - [x] 2.1 Implement the `ForwardingSink` Ecto schema
  ...
  - [x] 2.2 Implement the `SinkSecret` Ecto schema
  ...
  - [x] 2.3 Extend the `SensorPool` schema with forwarding fields
  ...
  - [x]* 2.4 Write property tests for sink name normalization (Property 2)
  ...
  - [x]* 2.5 Write property test for schema mode validation (Property 13)
...
- [x] 3. Encryption module
  - [x] 3.1 Implement `ConfigManager.Forwarding.Encryption`
  ...
  - [x]* 3.3 Write property test for secret masking (Property 12)
...
- [x] 5. Validation modules
  - [x] 5.1 Implement `ConfigManager.Forwarding.SinkConfigSchema`
  ...
  - [x] 5.2 Implement `ConfigManager.Forwarding.DestinationValidator`
  ...
  - [x]* 5.3 Write property test for destination validation (Property 9)
...
- [x] 6. Connection tester module
  - [x] 6.1 Implement `ConfigManager.Forwarding.ConnectionTester`
  ...
  - [x]* 6.2 Write property test for concurrency limiting (Property 14)
...
- [x] 7. Forwarding context module
  - [x] 7.1 Implement `ConfigManager.Forwarding` context — CRUD operations
  ...
  - [x] 7.2 Implement `ConfigManager.Forwarding` context — schema mode and connection testing
  ...
  - [x]* 7.3 Write property test for config version increment (Property 5)
  ...
  - [x]* 7.4 Write property test for cross-pool access denial (Property 6)
  ...
  - [x]* 7.5 Write property test for secret preservation on unchanged edit (Property 11)
  ...
  - [x]* 7.6 Write property test for transactional audit integrity (Property 8)
...
- [x] 9. RBAC policy verification
  - [x] 9.1 Verify canonical `forwarding:manage` permission in the Policy module
  ...
  - [x]* 9.2 Write property test for RBAC enforcement (Property 1)
...
- [x] 10. Router and navigation
  - [x] 10.1 Add forwarding routes to the router
...
- [x] 11. LiveView — Forwarding Overview page
  - [x] 11.1 Implement `ForwardingLive.OverviewLive`
  ...
  - [x] 11.2 Create the overview page template/render
...
- [x] 12. LiveView — Sink Form (Create/Edit)
  - [x] 12.1 Implement `ForwardingLive.SinkFormLive`
  ...
  - [x] 12.2 Create the sink form template/render
...
- [x] 13. Sensor detail page forwarding section
  - [x] 13.1 Update `SensorDetailLive` forwarding section
...
- [x] 15. Audit and secret sanitization integration
  - [x] 15.1 Verify audit entry sanitization across all forwarding actions
  ...
  - [x]* 15.2 Write property test for audit completeness and sanitization (Property 7)
  ...
  - [x]* 15.3 Write property test for secret leak prevention (Property 4)
...
- [x] 16. PubSub integration and real-time updates
  - [x] 16.1 Wire PubSub broadcasts in the Forwarding context
...
- [x] 17. Cascade delete and pool integration
  - [x] 17.1 Verify cascade delete behavior
  ...
  - [x]* 17.2 Write property test for cascade delete (Property 10)
