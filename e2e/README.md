...
The full profile covers login, dashboard/sensor visibility, pools, forwarding sinks, deployments, rules, BPF, PCAP search/history/detail/manifest/download entry points, support bundles, admin user/role/token pages, and audit filtering/export.
