...
- [x] 1. Create `internal/ringctl` shared protocol package
  ...
  - [x] 1.1 Write property test for Ring_Control_Protocol serialization round-trip
...
- [x] 2. Fix alert severity logic and `mark_pre_alert` timestamp field
  ...
  - [x] 2.1 Write property test for severity filter correctness
...
- [x] 3. Implement Alert_Listener HTTP server and extend AlertEvent struct
  ...
  - [x] 3.1 Write property test for alert payload validation
...
- [x] 4. Implement alert deduplication
  ...
  - [x] 4.1 Write property test for alert deduplication within the time window
...
- [x] 5. Checkpoint — Phase 1 reliability
  - Ensure all tests pass, ask the user if questions arise.

- [x] 6. Implement real Podman container lifecycle control
  ...
  - [x] 6.1 Write property test for container restart allowlist enforcement
...
- [x] 7. Implement safe BPF filter change handling
  ...
  - [x] 7.1 Write property test for BPF filter validation before state mutation
  ...
  - [x] 7.2 Write property test for BPF filter change audit log completeness
...
- [x] 8. Implement `SwitchMode` container orchestration
...
- [x] 9. Checkpoint — Phase 2 manageability (container lifecycle)
  - Ensure all tests pass, ask the user if questions arise.

- [x] 10. Implement Vector configuration templating
  ...
  - [x] 10.1 Write property test for Vector config sink isolation
...
- [x] 11. Harden control-plane security
...
- [x] 12. Checkpoint — Phase 2 manageability (security + config)
  - Ensure all tests pass, ask the user if questions arise.

- [x] 12.5. Expose BPF "restart required" status to Config_Manager
...
- [x] 13. Rewrite pcap_ring_writer capture loop to TPACKET_V3
...
- [x] 14. Add pcap_ring_writer benchmark harness
...
- [x] 15. Checkpoint — Phase 3 throughput
  - Ensure all tests pass, ask the user if questions arise.

- [x] 16. Extend PCAP index schema and `PcapFile` model
  ...
  - [x] 16.1 Write property test for PCAP index entry completeness and round-trip fidelity
...
- [x] 17. Implement SHA256 hashing and Chain_of_Custody_Manifest
  ...
  - [x] 17.1 Write property test for Chain_of_Custody_Manifest access event append
...
- [x] 18. Implement PCAP retention pruning
  ...
  - [x] 18.1 Write property test for retention pruning
...
- [x] 19. Extend health collector with per-consumer statistics
  ...
  - [x] 19.1 Write property test for health report drop alert flag accuracy
...
- [x] 20. Checkpoint — Phase 4 analyst utility
  - Ensure all tests pass, ask the user if questions arise.

- [x] 21. Implement Host_Readiness_Checker NIC and host tuning validation
  ...
  - [x] 21.1 Write property test for readiness checker failure report completeness
...
- [x] 22. Implement bootstrap state machine
  ...
  - [x] 22.1 Write property test for bootstrap state machine forward-only transitions
  ...
  - [x] 22.2 Write property test for enrollment retry exponential backoff
  ...
  - [x] 22.3 Write property test for config validation before file write
...
- [x] 23. Implement `sensorctl enroll` command
...
- [x] 24. Wire all components and final integration
